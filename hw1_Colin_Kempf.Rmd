...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Colin Kempf** and I am a sophmore from Cedar   Rapids, Iowa. I am majoring in *Software Engineering* and studying Data Science as my minor. I am looking forward to getting to know the coding language we will be using in this class and further understanding what I started to learn in 201
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think that the most obvious job that data science is related to is something along the lines of data analysis. Data scientists are experts at sorting data and organizing it based on different categories to find trends and relationships of datasets. Analyzing this is an important part of understanding why the data is the way it is. If data scientists can do that then whoever has hired them may have a better idea of why the data is working for or against them. 
...
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.
    ...
    Answer:  I think I will be most interested on thing that relate to data on a global level. That might have to do with population, or economy, health systems, or politics. Those larger subjects interest me in how they can relate to each other and how they are different around the world.
